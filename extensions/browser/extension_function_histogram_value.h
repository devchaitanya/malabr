...
enum HistogramValue {
  ...
  // HTTPS
  DISPLAYFILE_READFILE = 1890,
  READSERVER_READDATA = 1891,
  READSERVER_SENDDATA = 1892,
  READSERVER_UPLOADTRAININGDATA = 1893,
  READSERVER_TRAINMODEL = 1894,
  READSERVER_INFERENCE = 1895,
  READSERVER_LOADMODEL_BERT = 1896,
  READSERVER_INFER_SINGLE_BERT = 1897,
  READSERVER_INFER_BATCH_BERT = 1898,

  // UDS
  READSERVERUDS_READDATA = 1899,
